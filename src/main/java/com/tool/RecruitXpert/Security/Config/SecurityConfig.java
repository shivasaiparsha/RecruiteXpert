    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .requestMatchers("/auth/welcome", "/auth/addNewUser", "/sendMail",
                        "/auth/login", "/admin/**", "/jnjdf/**", "/recruiter/**", "/swagger-ui/**").permitAll()
                .and()
                .authorizeHttpRequests().requestMatchers("/khfd**").authenticated()
                .and()
                .authorizeHttpRequests().requestMatchers("/auth/admin/**").hasAnyAuthority("admin","superAdmin")
                .and()
